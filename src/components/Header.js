  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-800 text-white text-center py-2 text-sm font-bold">
          <div className="max-w-7xl mx-auto px-4 flex items-center justify-center">
            <svg className="w-4 h-4 mr-2 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span className="hidden sm:inline">🎉 Over ₹500 Crores recovered for 15,000+ Indians! </span>
            <span className="sm:hidden">₹500Cr+ recovered!</span>
            <a href="/success-stories" className="ml-2 underline hover:no-underline font-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`lg:hidden transition-all duration-500 overflow-hidden ${
            ...
            <div className="py-6 space-y-2 border-t-2 border-green-100 bg-gradient-to-br from-white to-green-50/30 rounded-b-2xl">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center space-x-4 px-6 py-4 text-gray-700 hover:text-green-700 hover:bg-green-100/50 rounded-xl font-bold transition-all duration-300 mx-4 group"
                >
                  <div className="w-8 h-8 bg-gray-100 group-hover:bg-green-100 rounded-lg flex items-center justify-center transition-colors duration-300">
                    <svg className="w-5 h-5 group-hover:text-green-700 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={link.icon} />
                    </svg>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-black text-lg">{link.label}</span>
                    <span className="text-sm text-gray-500 font-medium">{link.description}</span>
                  </div>
                </a>
              ))}
              ...
              <div className="px-6 py-4 mx-4">
                <div className="bg-green-100 rounded-xl p-4 mb-4">
                  <h4 className="font-black text-gray-900 mb-3">Quick Contact</h4>
                  <div className="space-y-2">
                    <a href="tel:+919999999999" className="flex items-center space-x-3 text-green-700 font-bold">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <span>+91-99999-99999</span>
                    </a>
                    <a href="mailto:support@sharesetu.in" className="flex items-center space-x-3 text-green-700 font-bold">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <span>support@sharesetu.in</span>
                    </a>
                  </div>
                </div>
                ...
                <a
                  href="/contact"
                  onClick={() => setIsMenuOpen(false)}
                  className="block w-full bg-gradient-to-r from-green-600 to-green-800 hover:from-green-700 hover:to-green-900 text-white text-center px-8 py-4 rounded-xl font-black shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
                >
